...
<body>
   ...
   <header class="header header__about">
      <div class="container container-rel">
         ...
         <div class="header__down">
            <div class="header__down-about">
               <p class="header__down-about-text">
                  Мы - группа компаний, объединяющая 4 направления деятельности: <b
                     class="header__down-about-text-b">продажу оборудования, продажу софта,
                     IT-услуги и образовательный центр обучения в сфере информационных технологий.</b>
               </p>
               <hr class="header__down-about-line">
               <p class="header__down-about-subtext">
                  Наша компания обладает главным преимуществом — мы делаем под ключ все процессы в сфере информационных
                  технологий. Мы готовы предложить нашим клиентам полный спектр IT-услуг, начиная от подбора
                  оборудования и программного обеспечения, заканчивая техническим обслуживанием и обучением
                  специалистов.
               </p>
               <p class="header__down-about-subtext">
                  У нас работает высококвалифицированный юридический отдел, который знаком со всеми законами и
                  правилами, действующими в РФ в сфере информационных технологий. Это позволяет нам гарантировать
                  соответствие работ, которые мы выполняем, всем нормативным актам, что является одним из ключевых
                  критериев высокого качества выполненной работы.
               </p>
               <p class="header__down-about-subtext">
                  Мы постоянно ищем новые возможности для роста и развития, а также улучшения качества наших услуг. Мы
                  гордимся своими проектами и заботимся о каждом клиенте, предлагая индивидуальный подход и решения,
                  которые отвечают уникальным потребностям и целям.
               </p>
            </div>
         </div>
      </div>
   ...
   <section class="values">
      <div class="container">
         <p class="values__title">
            Наши <b class="values__title-b">ценности</b>
         </p>
         <div class="values__body">
            <div class="values__body-item">
               <p class="values__body-item-title">
                  Высокий профессионализм
               </p>
               <p class="values__body-item-subtitle">
                  Мы стремимся обеспечить клиентов квалифицированными и опытными специалистами, которые помогут в
                  решении любых задач в сфере IT.
               </p>
            </div>
            ...
            <div class="values__body-item">
               ...
               <p class="values__body-item-subtitle">
                  Мы всегда на шаг впереди, ищем новые технологии и подбираем современные и актуальные решения для наших
                  клиентов.
               </p>
            </div>
            ...
            <div class="values__body-item">
               ...
               <p class="values__body-item-subtitle">
                  Мы высоко оцениваем результаты своей работы и стремимся к максимально качественному и эффективному
                  решению задач наших клиентов.
               </p>
            </div>
            ...
            <div class="values__body-item">
               ...
               <p class="values__body-item-subtitle">
                  Мы ценим каждого члена нашей команды и привлекаем лучших специалистов, которые готовы работать на
                  общее дело и достигать новых высот вместе с нами
               </p>
            </div>
         </div>
      </div>
   ...
   <section class="why" id="pri">
      <div class="container">
         <p class="why__title why__title-about">
            Наши <b class="why__title-b">принципы</b>
         </p>
         <div class="why__flex">
            <div class="why__flex-item">
               ...
               <p class="why__flex-item-subtitle">
                  Мы готовы слушать и адаптироваться для того, чтобы удовлетворить потребности и требования каждого
                  клиента.
               </p>
            </div>
            <div class="why__flex-item">
               ...
               <p class="why__flex-item-title">
                  Прозрачность<br> и открытость
               </p>
               <p class="why__flex-item-subtitle">

                  Мы строим доверительные отношения с нашими клиентами на основе честности и открытости во всем, что мы
                  делаем.
               </p>
            </div>
            <div class="why__flex-item">
            ...
            <div class="why__flex-item why__flex-item-about">
            ...
            <div class="why__flex-item">
               ...
               <p class="why__flex-item-subtitle">
                  Мы считаем, что наш успех зависит от успеха наших клиентов. Поэтому мы всегда помогаем клиентам
                  закрыть с нами все свои потребности в сфере информационных технологий.
               </p>
            </div>
            <div class="why__flex-item">
               <svg class="why__flex-item-line" width="440" height="1" viewBox="0 0 440 1" fill="none"
               ...
               <p class="why__flex-item-title">
                  Интерес каждого сотрудника
               </p>
               <p class="why__flex-item-subtitle">
                  Мы заботимся о карьерном и личностном росте каждого члена нашей команды, ведь успешная компания - это
                  результат совместных усилий опытных и мотивированных специалистов.
               </p>
            </div>
         </div>
      </div>
