...
<head>
   ...
   <link rel="stylesheet" href="css/tech-prime.css">
</head>
...
<body>
   <div class="popup-bg">
      <div class="popup">
         <div class="container">
            <img src="images/tech-primelogo-white.svg" alt="#" class="popup-logo-ico">
      ...
      <div class="container container-rel">
         <div class="header__upper">
            <div class="header__upper-logo">
               <img src="images/tech-primelogo.svg" alt="#" class="header__upper-logo-ico">
            </div>
               ...
               <div class="header__upper-div-up">
                  ...
                  <div class="header__upper-div-up-burger open-main-menu">
                     <svg width="40" height="22" viewBox="0 0 40 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="40" height="2" rx="1" fill="#1B1B20" />
                        <rect y="10" width="40" height="2" rx="1" fill="#1B1B20" />
                        <rect y="20" width="40" height="2" rx="1" fill="#1B1B20" />
                     </svg>
                  </div>
               </div>
         ...
         <div class="header__center">
            <h1 class="header__center-title">
               <b class="header__center-title-b">Поставка компьютерного оборудования</b> для крупных организаций под
               ключ
            </h1>
         </div>
            ...
            <div class="header__down-block">
               ...
               <button class="header__down-btn2">
                  ...
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
                        d="M15 0C6.72632 0 0 6.72632 0 15C0 23.2737 6.72632 30 15 30C23.2737 30 30 23.2737 30 15C30 6.72632 23.2737 0 15 0ZM19.8316 15.7579L12.7579 20.463C12.1578 20.8736 11.3369 20.4315 11.3369 19.7051V10.2946C11.3369 9.56831 12.1579 9.1262 12.7579 9.53662L19.8316 14.2419C20.3684 14.5893 20.3684 15.4105 19.8316 15.7579Z"
                        fill="#BD2738" />
                  </svg>
            ...
            <div class="header__down-grid">
               <div class="header__down-grid-item">
                  <svg width="80" height="1" viewBox="0 0 80 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <rect width="80" height="1" fill="#bd2738" />
                  </svg>
                  <a href="#" class="header__down-grid-item-link">Подбираем оборудование которое решает ваши задачи</a>
               </div>
               <div class="header__down-grid-item">
                  <svg width="80" height="1" viewBox="0 0 80 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <rect width="80" height="1" fill="#bd2738" />
                  ...
                  <a href="#" class="header__down-grid-item-link">Учитываем выделенный на закупку бюджет </a>
               </div>
               <div class="header__down-grid-item">
                  <svg width="80" height="1" viewBox="0 0 80 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <rect width="80" height="1" fill="#bd2738" />
   ...
   <section class="services" id="uslugi">
      <div class="container">
         <h2 class="services__title">
            <b class="services__title-b">Оборудование</b>, которое мы можем поставить
         </h2>
         <div class="services__flex">
            <div class="services__flex-item">
               <img src="images/tech-prime-ico1.svg" alt="" class="services__flex-item-ico">
               <p class="services__flex-item-title">
                  Рабочие места
               </p>
               <p class="services__flex-item-subtitle">
                  Неттопы, ноутбуки, системные блоки, нетбуки, моноблоки, планшеты
               </p>
            </div>

            <div class="services__flex-item">
               <img src="images/tech-prime-ico2.svg" alt="" class="services__flex-item-ico">
               <p class="services__flex-item-title">
                  Серверное оборудование
               </p>
               <p class="services__flex-item-subtitle">
                  Серверы, СХД, серверные шкафы, любые серверные комплектующие
               </p>
            </div>

            <div class="services__flex-item">
               <img src="images/tech-prime-ico3.svg" alt="" class="services__flex-item-ico">
               <p class="services__flex-item-title">
                  Офисная оргтехника
               </p>
               <p class="services__flex-item-subtitle">
                  Принтеры, ламинаторы, сканеры, напольные аппараты, печатное оборудование, расходные материалы
               </p>
            </div>

            <div class="services__flex-item">
               <img src="images/tech-prime-ico4.svg" alt="" class="services__flex-item-ico">
               <p class="services__flex-item-title">
                  Интерактивное оборудование
               </p>
               <p class="services__flex-item-subtitle">
                  Проекторы, крепления, экраны, комплектующие, расходные материалы
               </p>
            </div>

            <div class="services__flex-item">
               <img src="images/tech-prime-ico5.svg" alt="" class="services__flex-item-ico">
               <p class="services__flex-item-title">
            ...
            <div class="services__flex-item">
               <img src="images/tech-prime-ico6.svg" alt="" class="services__flex-item-ico">
               <p class="services__flex-item-title">
                  Системы видео-конференций
               </p>
               <p class="services__flex-item-subtitle">
                  Лингофонные кабинеты, мобильные классы
               </p>
            </div>
         </div>
      </div>
   ...
   <section class="complex">
      <div class="container">
         <div class="complex__flex">
            <div class="complex__flex-item">
               <p class="complex__title">
                  <b class="complex__title-b">Комплексный</b> подход
               </p>
               <p class="complex__subtitle">
                  Выполняем все работы под ключ от поставки оборудования до установки и подключения
               </p>
            </div>
            ...
            <div class="complex__flex-item complex__flex-item-wrap">
               <div class="complex__flex-item-item">
                  ...
                  <p class="complex__flex-item-item-subtext">
                     Выстроить процесс работы с разными подрядчиками сложнее и длительнее. Из-за разделения
                     ответственности — нет гарантий качественного выполнения всего цикла работ.
                     <br>
                     <br>
                     У нас полностью налажены процессы по всем этапам создания компьютерной инфраструктуры.
                  </p>
               </div>
               <div class="complex__flex-item-item">
                  <p class="complex__flex-item-item-text">
                  ...
                  <p class="complex__flex-item-item-subtext">
                     Нет вероятности, что поставленное оборудование не подойдёт.
                     <br>
                     <br>
                     Наши компетенции позволяют учесть все факторы, чтобы выбранное для закупки оборудование полностью
                     соответствовало поставленным задачам.
                  </p>
               </div>
               <div class="complex__flex-item-item">
                  <p class="complex__flex-item-item-text">
                  ...
                  <p class="complex__flex-item-item-subtext">
                     При комплексной и отлаженной работе мы избавляемся от лишних издержек, что позволяет сэкономить
                     ваш выделенный бюджет.
                  </p>
               </div>
               <div class="complex__flex-item-item">
                  <p class="complex__flex-item-item-text">
                  ...
                  <p class="complex__flex-item-item-subtext">
                     После настройки оборудования мы оказываем техническую поддержку и даём консультации по возникающим
                     вопросам.
                  </p>
               </div>
            </div>
         ...
         <div class="generator__flex">
            <div class="generator__flex-item generator__flex-item1">
               <p class="generator__flex-item-title">
                  <b class="generator__flex-item-title-b">Производители</b> с которыми мы работаем
               </p>
               <p class="generator__flex-item-subtitle">
                  У нас широкий спектр производителей оборудования. Работаем как с импортными компаниями, так и с
                  ...
                  <svg class="generator__flex-item-link-svg" width="23" height="16" viewBox="0 0 23 16" fill="none"
                     ...
                     <g clip-path="url(#clip0_273_56)">
                        <path class="numbers__flex-item-btn-arrow-fill"
                           d="M7.4894 3.15288L16.2398 3.15288L16.2398 12.1022" stroke="#bd2738" stroke-width="1.5"
                           stroke-linecap="round" stroke-linejoin="round" />
                        <path class="numbers__flex-item-btn-arrow-fill" d="M15.6324 3.77393L6.76014 12.8479"
                           stroke="#bd2738" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                     </g>
                     <defs>
         ...
         <div class="firstform__flex">
            <div class="firstform__flex-item">
               <p class="firstform__flex-item-title">
                  Подберем оборудование для решения ваших задач с учётом выделенного бюджета
               </p>
   ...
   <section class="map">
      <div class="container container-rel">
         <img src="images/tech-prime-map.svg" alt="#" class="map__svg">
         <div class="map__point1">
            ...
            <svg class="map__point-svg" width="40" height="40" viewBox="0 0 40 40" fill="none"
               xmlns="http://www.w3.org/2000/svg">
               <circle cx="20" cy="20" r="19.5" fill="#bd2738" fill-opacity="0.2" stroke="#bd2738" />
               <circle cx="20" cy="20" r="10" fill="#bd2738" />
            </svg>
         </div>
   ...
   <section class="offer">
      <div class="container">
         <p class="offer__title">
            Что ещё мы можем <b class="offer__title-b">предложить</b>
         </p>
               ...
               <svg class="contacts__flex-down-btn-arrow" width="22" height="16" viewBox="0 0 22 16" fill="none"
                  ...
                  <g clip-path="url(#clip0_205_8)">
                     <path class="contacts__flex-down-btn-arrow-fill"
                        d="M6.9894 3.15288L15.7398 3.15288L15.7398 12.1022" stroke="#1b1b20" stroke-width="1.5"
                        stroke-linecap="round" stroke-linejoin="round" />
                     <path class="contacts__flex-down-btn-arrow-fill" d="M15.1324 3.77405L6.26014 12.848" stroke="#1b1b20"
                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                  <defs>
                     <clipPath id="clip0_205_8">
                        <rect width="22" height="15" fill="#1b1b20" transform="translate(0 0.5)" />
                     </clipPath>
                  </defs>
               </svg>
            </button>
   ...
   <footer class="footer">
      <div class="container container-rel">
         <div class="footer__flex">
            <img src="images/tech-primelogo.svg" alt="#" class="footer__flex-ico">
   ...
   <script src="js/tech-prime.js"></script>
</body>
