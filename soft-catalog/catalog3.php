...
<body>
         ...
         <div class="container">
            ...
            <div class="popup__flex">
               ...
               <div class="popup__flex-little">
                  <a href="../tech-prime.php" class="popup__flex-little-text">
                     Оборудование
                  </a>
   ...
   <header class="header header-catalog header-info">
      <div class="container container-rel">
         ...
         <div class="header__center">
            <a href="../soft.php" class="header__center-bread">Каталог</a>
            <h1 class="header__center-title header__center-title-catalog">
               “Системное ПО”
            </h1>
         </div>
         ...
         <div class="header__down">
            <div class="header__down-block">
               <button class="header__down-btn catalog-item-btn-catalog">
   ...
   <section class="solution">
      <div class="container">
         <div class="solution__flex">
            <p class="solution__flex-title">
               Решения
            </p>
            <div class="solution__flex-view">
               <p class="solution__flex-view-text">
                  Вид
               </p>
               <img src="../images/catalog-view1.svg" alt="view1" class="solution__flex-view-ico">
            </div>
         </div>
         <div class="solution__catalog">
            <div class="solution__catalog-item">
               <img src="../images/catalog-ico.png" alt="" class="solution__catalog-item-ico">
               <p class="solution__catalog-item-title">
                  Avira Internet Security Suite
               </p>
               <p class="solution__catalog-item-subtitle">
                  Совмещая функции антивируса, антифишинга, антиспама, резервного копирования файлов и отслеживания
                  посещаемых детьми web-страниц, Avira Internet Security Suite обеспечивает полную защиту ПК при
                  совершении покупок в Интернете, работе с банковскими счетами, проигрывании музыки и фильмов, а также
                  во время активного посещения социальных сетей.
               </p>
               <a href="#" class="solution__catalog-item-btn">
                  Узнать подробнее
               </a>
            </div>
            <div class="solution__catalog-item">
            ...
            <button class="contacts__flex-down-btn">
               ...
               <svg class="contacts__flex-down-btn-arrow" width="22" height="16" viewBox="0 0 22 16" fill="none"
                  ...
                  <g clip-path="url(#clip0_205_8)">
                     ...
                     <path class="contacts__flex-down-btn-arrow-fill" d="M15.1324 3.77405L6.26014 12.848" stroke="#fff"
                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                  <defs>
      ...
      <div class="container container-rel">
         <div class="footer__flex">
            ...
            <div class="footer__flex-nav">
               <a href="../tech-prime.php" class="footer__flex-nav-item">
                  Оборудование
               </a>
   ...
   <script src="../js/soft-catalog.js"></script>
</body>
